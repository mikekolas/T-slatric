...
@section('content')
  ...
  <div class="well">
    <img id="aboutImg" class="img-rounded" class="img-responsive" src="site_images/about.jpg">
    <h4 style="text-align:justify;">Hi! I am Michael-Alexandros Savvanis, a 22 years old guy with a passion for creativity,
     ...
     <h4 style="text-align:justify;">The Hardware of this implementation is an Arduino Uno with the addition
        ...
        The user can log in in the web app and see realtime graph of energy consumption and energy consumed on the last quarter.
     </h4>
     <h4 style="text-align:justify;">
        The Software of this implementation are the following technologies:
        HTML, CSS, JavaScript, PHP, Laravel, Bootstrap.
     </h4>
     <img class="img-responsive" src="site_images/Circuit_bb.png">
  </div>
@endsection
